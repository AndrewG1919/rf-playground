...
class AMDemod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "AMDemod")
        ...
        self._volume_range = qtgui.Range(0, 50e-3, 1e-3, 20e-3, 200)
        ...
        self.analog_agc2_xx_0 = analog.agc2_ff((1e-2), (1e-3), 1.0, 1.0, 13000)
        ...
        self.connect((self.rational_resampler_xxx_1, 0), (self.qtgui_time_sink_x_1, 0))
